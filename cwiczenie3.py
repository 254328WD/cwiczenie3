...
def extract_texture_features(folder_path, distances=[1, 3, 5], angles=[0, np.pi / 4, np.pi / 2, 3 * np.pi / 4]):
    ...
    for index, file_name in enumerate(files):
        if file_name.endswith('.jpg'):
            ...
            features = {'file': file_name, 'category': file_name.split('_')[0]}
...
source_folders = [
    r"D:\studia wojtek\2 stopien\semestr 1\Programowanie w obliczeniach inteligentnych\zdj\1",
    r"D:\studia wojtek\2 stopien\semestr 1\Programowanie w obliczeniach inteligentnych\zdj\2",
    r"D:\studia wojtek\2 stopien\semestr 1\Programowanie w obliczeniach inteligentnych\zdj\3"
]
